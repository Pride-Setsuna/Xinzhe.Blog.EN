...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，I am a programmer,Hi，I love new technologies,Have ideals，love life,Welcome to my blog! 🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Xinzhe', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || 'Dream it. Chase it. Code it.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://en.shintetu.com', // 网站地址
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'Pride-Setsuna/giscus_EN', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOKsGcsA', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
        process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOKsGcsM4Ca3uG', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
